package com.smertbox.security.core.interceptor;
...
/**
 * Updator : ladeng
 * Time: 2016年9月9日 下午9:22:51
 * Desc : 重写了Spring Security FilterSecurityInterceptor类
 */
...
public class FilterSecurityInterceptor extends AbstractSecurityInterceptor implements
	...
	public void doFilter(ServletRequest request, ServletResponse response,FilterChain chain,boolean interception) throws IOException, ServletException {
	...
	public void invoke(FilterInvocation fi) throws IOException, ServletException {
		if ((fi.getRequest() != null)
			...
			try{
				if(token==null&&interception){
					throw new AccessDeniedException("Access Denied");
				}
			}catch(AccessDeniedException e){
				accessDeniedHandler.handle(fi.getRequest(), fi.getResponse(), e);
				return;
			}
