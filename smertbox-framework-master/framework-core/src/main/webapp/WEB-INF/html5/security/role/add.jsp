										...
										<tr>
											...
											<td>
												<div class="form-group form-group-table">
													<input type="text" placeholder="角色名称" class="form-control" id="roleName" name="roleName">
												</div>
											</td>
										</tr>
										<tr>
											...
											<td>
												<div class="form-group form-group-table">
													<input type="text" placeholder="角色描述" class="form-control" id="roleDesc" name="roleDesc"> 
												</div>
											</td>
										</tr>
										<tr>
		 						...
		 						callback: function (value, validator) {
		 							...
		 							if (value!='') {
	 									$.ajax({
	 										...
	 										type: 'post',
	 										async: false,
	 										data: {"max":"0","roleName": value,'_csrf':$("meta[name='_csrf']").attr("content"),'_csrf_header':$("meta[name='_csrf_header']").attr("content")},
