...
<div class="animated">
                                ...
                                <div class="table-responsive table-top-border-none">
									<table class="table table-bordered">
										<tr>
											...
											<td>
												<div class="form-group form-group-table">
													<input type="text" placeholder="菜单名称" class="form-control" id="menuName" name="menuName">
												</div>
											</td>
										</tr>
										<tr>
											...
											<td>
												<div class="form-group form-group-table">
													<input type="text" placeholder="父级菜单" class="form-control" id="menuTree" onclick="showMenu(this);" readonly>
										...
										<tr>
											...
											<td>
												<div class="form-group form-group-table">
													<input type="text" placeholder="菜单描述" class="form-control" id="menuDesc" name="menuDesc"> 
												</div>
											</td>
										</tr>
										<tr>
											...
											<td>
												<div class="form-group form-group-table">
													<input type="text" placeholder="className" class="form-control" id="className" name="className"> 
												</div>
											</td>
										</tr>
										<tr>
											...
											<td>
												<div class="form-group form-group-table">
													<input type="text" placeholder="leftIconClass" class="form-control" id="leftIconClass" name="leftIconClass"> 
												</div>
											</td>
										</tr>
										<tr>
											...
											<td>
												<div class="form-group form-group-table">
													<input type="text" placeholder="titleClass" class="form-control" id="titleClass" name="titleClass"> 
												</div>
											</td>
										</tr>
										<tr>
											...
											<td>
												<div class="form-group form-group-table">
													<input type="text" placeholder="rightIconClass" class="form-control" id="rightIconClass" name="rightIconClass"> 
												</div>
											</td>
										</tr>
										<tr>
										...
										<tr>
											...
											<td>
												<div class="form-group form-group-table">
													<input type="text" placeholder="菜单访问地址" class="form-control" id="resourceTree" onclick="showMenu(this);" readonly>
										...
										<tr>
											...
											<td>
												<div class="form-group form-group-table">
													<input type="text" placeholder="菜单类型" class="form-control" id="menuType" name="menuType" value="一级菜单">
												</div>
											</td>
										</tr>
										<tr>
	...
	$(document).ready(function() {
		 						...
		 						callback: function (value, validator) {
		 							...
		 							if (value!='') {
	 									$.ajax({
	 										...
	 										type: 'post',
	 										async: false,
	 										data: {"max":"0","menuName": value,'_csrf':$("meta[name='_csrf']").attr("content"),'_csrf_header':$("meta[name='_csrf_header']").attr("content")},
		...
		// 添加下拉单选控件
		zTreeSingleCheck("menuPid","menuTree","/security/menu/menuTree");
		// 添加下拉单选控件
		zTreeSingleCheck("menuUrl","resourceTree","/security/menu/resourceTree");
		// 添加上传控件
