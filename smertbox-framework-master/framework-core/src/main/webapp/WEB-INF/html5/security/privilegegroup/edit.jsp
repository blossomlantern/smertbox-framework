...
<div class="animated">
			...
			<div class="ibox float-e-margins">
				...
				<div class="ibox-content">
					<form id="form" method="post" class="form-horizontal">
								...
								<input type="hidden" id="pgId" name="pgId" value="${vobj.pgId}">
                                		...
                                		<tr>
                                			...
                                			<td>
                                				<div class="form-group form-group-table">
							                    	<input type="text" placeholder="权限组名称" class="form-control" id="pgName" name="pgName" value="${vobj.pgName}">
			                                    </div>
                                			</td>
                                		</tr>
                                		<tr>
                                			...
                                			<td>
                                				<div class="form-group form-group-table">
			                                    	<input type="text" placeholder="权限组描述" class="form-control" id="pgDesc" name="pgDesc" value="${vobj.pgDesc}"> 
			                                    </div>
                                			</td>
                                		</tr>
                                		<tr>
	...
	function submitForm(){
		...
		if($("#form").data('bootstrapValidator').isValid()){
			$.ajax({
				url: server+'/security/privilegegroup/edit',
				type:'post',
				data:$("#form").serialize(),
				async:false,
