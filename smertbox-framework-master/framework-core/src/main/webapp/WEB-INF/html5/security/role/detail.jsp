                                ...
                                <div class="table-responsive table-top-border-none">
									<table class="table table-bordered">
										<tr>
											...
											<td>
												<p class="form-control-static form-control-table-p">${vobj.roleName}</p>
											</td>
										</tr>
										<tr>
											<td class="dt-align-right">
											...
											<td>
												<p class="form-control-static form-control-table-p">${vobj.roleDesc}</p>
											</td>
										</tr>
										<tr>
											<td class="dt-align-right">
											...
											<td>
												<p class="form-control-static form-control-table-p">
		                                    		<c:if test="${vobj.roleType=='dev'}">开发</c:if>
		                                    		<c:if test="${vobj.roleType=='system'}">系统</c:if>
		                                    	</p>
											</td>
										</tr>
										<tr>
