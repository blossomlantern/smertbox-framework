...
<!-- <div id="menuContent" class="menuContent" style="display:none; position: absolute;background:#ffffff;border:1px solid #1ab394;">
	...
	function submitForm(){
		...
		$.ajax({
			url: server+'/security/rolerolegroup/save',
			type:'post',
			data:{rgId:"${rgId}",nodes:checkeds,'_csrf':$("meta[name='_csrf']").attr("content"),'_csrf_header':$("meta[name='_csrf_header']").attr("content")},
			async:false,
