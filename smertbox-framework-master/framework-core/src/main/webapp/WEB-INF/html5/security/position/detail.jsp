								...
								<div class="table-responsive table-top-border-none">
									<table class="table table-bordered">
										...
										<tr>
											...
											<td>
												<p class="form-control-static form-control-table-p">
			                                    		<c:if test="${vobj.positionType=='technology'}">技术类</c:if>
			                                    		<c:if test="${vobj.positionType=='management'}">管理类</c:if>
			                                    		<c:if test="${vobj.positionType=='other'}">其它类</c:if>
												</p>
											</td>
										</tr>
										<tr>
											...
											<td>
												<p class="form-control-static form-control-table-p">
			                                    		<c:if test="${vobj.positionLevel=='junior'}">初级</c:if>
			                                    		<c:if test="${vobj.positionLevel=='middle'}">中级</c:if>
			                                    		<c:if test="${vobj.positionLevel=='high'}">高级</c:if>
			                                    		<c:if test="${vobj.positionLevel=='master'}">顶级</c:if>
											</td>
										</tr>
										<tr>
											<td class="dt-align-right">
											...
											<td>
												<p class="form-control-static form-control-table-p">
				                                        <c:if test="${vobj.islimit==0}">通用</c:if>
				                                        <c:if test="${vobj.islimit==1}">不通用</c:if>
				                                </p>
											</td>
										</tr>
										<tr>
											...
											<td>
												<p class="form-control-static form-control-table-p">
				                                        <c:if test="${vobj.allowEdit==1}">允许编辑</c:if>
				                                        <c:if test="${vobj.allowEdit==0}">不允许编辑</c:if>
			                                    </p> 
											</td>
										</tr>
										<tr>
											...
											<td>
												<p class="form-control-static form-control-table-p">
				                                        <c:if test="${vobj.allowDel==1}">允许删除</c:if>
				                                        <c:if test="${vobj.allowDel==0}">不允许删除</c:if>
			                                    </p>
											</td>
										</tr>
										<tr>
