...
<div class="animated">
										...
										<tr>
											...
											<td>
												<div class="form-group form-group-table">
													<input type="text" placeholder="职位名称" class="form-control" id="positionName" name="positionName">
												</div>
											</td>
										</tr>
										<tr>
											...
											<td>
												<div class="form-group form-group-table">
													<input type="text" placeholder="职位描述" class="form-control" id="positionDesc" name="positionDesc"> 
												</div>
											</td>
										</tr>
										<tr>
											...
											<td>
												<div class="form-group form-group-table">
													<select class="form-control"id="positionType" name="positionType">
			                                    		<option value="technology">技术类</option>
											...
											<td>
												<div class="form-group form-group-table">
													<div class="i-checks" style="padding-top:3px;">
				                                        <input type="radio" checked value="0"  id="islimit" name="islimit"> <i></i> 通用 &nbsp; &nbsp; &nbsp; &nbsp;
				                                        <input type="radio" value="1"  id="islimit" name="islimit"> <i></i> 不通用
			                                        </div>
												</div>
											</td>
										</tr>
		 						...
		 						callback: function (value, validator) {
		 							...
		 							if (value!='') {
	 									$.ajax({
	 										...
	 										type: 'post',
	 										async: false,
	 										data: {"max":"0","positionName": value,'_csrf':$("meta[name='_csrf']").attr("content"),'_csrf_header':$("meta[name='_csrf_header']").attr("content")},
	...
	function submitForm(){
		...
		if($("#form").data('bootstrapValidator').isValid()){
			$.ajax({
				url: server+'/security/position/add',
				type:'post',
				data:$("#form").serialize(),
				async:false,
				success:function(data){
