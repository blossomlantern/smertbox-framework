...
<div class="animated">
			...
			<div class="ibox float-e-margins">
				...
				<div class="ibox-content">
					<form id="form" method="post" class="form-horizontal">
								...
								<input type="hidden" id="rgId" name="rgId" value="${vobj.rgId}">
                                		...
                                		<tr>
                                			...
                                			<td>
                                				<div class="form-group form-group-table">
							                    	<input type="text" placeholder="角色组名称" class="form-control" id="rgName" name="rgName" value="${vobj.rgName}">
			                                    </div>
                                			</td>
                                		</tr>
                                		<tr>
                                			...
                                			<td>
                                				<div class="form-group form-group-table">
			                                    	<input type="text" placeholder="角色组描述" class="form-control" id="rgDesc" name="rgDesc" value="${vobj.rgDesc}"> 
			                                    </div>
                                			</td>
                                		</tr>
                                		<tr>
		 						...
		 						callback: function (value, validator) {
		 							...
		 							if (value!='') {
	 									$.ajax({
	 										...
	 										type: 'post',
	 										async: false,
	 										data: {"max":"1","rgName": value,'_csrf':$("meta[name='_csrf']").attr("content"),'_csrf_header':$("meta[name='_csrf_header']").attr("content")},
	...
	function submitForm(){
		...
		if($("#form").data('bootstrapValidator').isValid()){
			$.ajax({
				url: server+'/security/rolegroup/edit',
				type:'post',
				data:$("#form").serialize(),
				async:false,
				success:function(data){
