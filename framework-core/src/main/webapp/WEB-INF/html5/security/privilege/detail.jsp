					...
					<form id="form" method="post" class="form-horizontal">
								...
								<table class="table table-bordered">
									<tr>
										...
										<td>
											<p class="form-control-static form-control-table-p">${vobj.pvgName}</p>
										</td>
									</tr>
									<tr>
										<td class="dt-align-right">
										...
										<td>
											<p class="form-control-static form-control-table-p">${vobj.pvgPidName}</p>
										</td>
									</tr>
									<tr>
										<td class="dt-align-right">
									...
									<tr>
										...
										<td>
											<p class="form-control-static form-control-table-p">${vobj.pvgDesc}</p>
										</td>
									</tr>
									<tr>
										<td class="dt-align-right">
										...
										<td>
											<p class="form-control-static form-control-table-p">
	                                    		<c:if test="${vobj.pvgType=='url'}">请求地址</c:if>
	                                    		<c:if test="${vobj.pvgType=='button'}">按钮权限</c:if>
	                                    	</p>
										</td>
									</tr>
									<tr>
