								...
								<div class="table-responsive table-top-border-none">
									<table class="table table-bordered">
										<tr>
											...
											<td>
												<div class="form-group form-group-table"><input type="text" placeholder="权限组名称" class="form-control" id="pgName" name="pgName"></div>
											</td>
										</tr>
										<tr>
											<td class="dt-align-right">
											...
											<td>
												<div class="form-group form-group-table"><input type="text" placeholder="权限组描述" class="form-control" id="pgDesc" name="pgDesc"></div>
											</td>
										</tr>
										<tr>
											<td class="dt-align-right">
...
<!-- <div id="menuContent" class="menuContent" style="display:none; position: absolute;background:#ffffff;border:1px solid #1ab394;">
		                    ...
		                    stringLength: {
		   	                 ...
		   	                 callback: {
		 						...
		 						callback: function (value, validator) {
		 							...
		 							if (value!='') {
	 									$.ajax({
	 										url: server + '/security/privilegegroup/isExist',
	 										type: 'post',
	 										async: false,
	 										data: {"max":"0","pgName": value,'_csrf':$("meta[name='_csrf']").attr("content"),'_csrf_header':$("meta[name='_csrf_header']").attr("content")},
	...
	function submitForm(){
		...
		if($("#form").data('bootstrapValidator').isValid()){
			$.ajax({
				url: server+'/security/privilegegroup/add',
				type:'post',
				data:$("#form").serialize(),
				async:false,
				success:function(data){
