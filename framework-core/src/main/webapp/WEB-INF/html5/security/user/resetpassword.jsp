			...
			<div class="ibox float-e-margins">
				...
				<div class="ibox-content">
					<form id="form" method="post" class="form-horizontal">
								...
								<input type="hidden" id="loginAccount" name="loginAccount" value="${vobj.loginAccount}">
								<div class="table-responsive table-top-border-none">
									<table class="table table-bordered">
										<tr>
											...
											<td>
												<div class="form-group form-group-table"><input type="text" placeholder="请输入新密码" class="form-control" id="passwd" name="passwd"></div>
											</td>
										</tr>
										<tr>
											<td colspan="2">
...
<!-- <div id="menuContent" class="menuContent" style="display:none; position: absolute;background:#ffffff;border:1px solid #1ab394;">
	...
	function submitForm(){
		...
		if($("#form").data('bootstrapValidator').isValid()){
			$.ajax({
				url: server+'/security/user/resetpassword',
				type:'post',
				data:$("#form").serialize(),
				async:false,
