										...
										<tr>
											...
											<td>
												<div class="form-group form-group-table">
													<input type="text" placeholder="Job名称" class="form-control" id="jobName" name="jobName">
												</div>
											</td>
										</tr>
										<tr>
											...
											<td>
												<div class="form-group form-group-table">
                                     				<input type="text" placeholder="Job描述" class="form-control" id="jobDescription" name="jobDescription">
												</div>
											</td>
										</tr>
										<tr>
											...
											<td>
												<div class="form-group form-group-table">
													<input type="text" placeholder="触发器名称" class="form-control" id="triggerName" name="triggerName"> 
												</div>
											</td>
										</tr>
										<tr>
											...
											<td>
												<div class="form-group form-group-table">
													<input type="text" placeholder="触发器描述" class="form-control" id="triggerDescription" name="triggerDescription"> 
												</div>
											</td>
										</tr>
										<tr>
											...
											<td>
												<div class="form-group form-group-table">
													<input type="text" placeholder="执行类名" class="form-control" id="jobClassName" name="jobClassName"> 
												</div>
											</td>
										</tr>
										<tr>
											...
											<td>
												<div class="form-group form-group-table">
													<input type="text" placeholder="时间表达式" class="form-control" id="cronExpression" name="cronExpression"> 
												</div>
											</td>
										</tr>
										<tr>
		    	  		...
		    	  		validators: {
		                    ...
		                    stringLength: {
		 						...
		 						callback: function (value, validator) {
		 							...
		 							if (value!='') {
	 									$.ajax({
	 										url: server + '/system/quartz/jobClassIsExist',
	 										type: 'post',
	 										async: false,
	 										data: {"max":"0","jobClass": value,'_csrf':$("meta[name='_csrf']").attr("content"),'_csrf_header':$("meta[name='_csrf_header']").attr("content")},
