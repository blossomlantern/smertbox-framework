	                               		...
	                               		<tr>
											...
											<td style="width:20%;">
												<div class="form-group form-group-table">
													<input type="text" placeholder="参数Id" class="form-control" id="parId" name="parId" readonly value="${vobj.parId}">
												</div>
											</td>
											<td style="width:20%;text-align:center;">
		 						...
		 						callback: function (value, validator) {
		 							...
		 							if (value!='') {
	 									$.ajax({
	 										...
	 										type: 'post',
	 										async: false,
	 										data: {"max":"1","parKey": value,'_csrf':$("meta[name='_csrf']").attr("content"),'_csrf_header':$("meta[name='_csrf_header']").attr("content")},
